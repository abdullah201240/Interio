...
const endpoints = {
  ...
  sendResetCode: `${API_BASE_URL}/user/forget-password`,
  verifyResetCode: `${API_BASE_URL}/user/forget-password/verify`,
  resetPassword: `${API_BASE_URL}/user/forget-password/reset`
};
